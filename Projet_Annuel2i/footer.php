		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 to-animate">
					...
					<p>N'hésitez pas à nous envoyer un message, tout retour est apprécié.</p>
				...
				<div class="col-md-4 to-animate">
					...
					<ul class="contact-info">
						<li><i class="icon-map-marker"></i>14 Boulevard Beaumarchais,Paris 75004</li>
						<li><i class="icon-phone"></i>+ 142 71 75 55</li>
						<li><i class="icon-envelope"></i><a href="#">WorkinShare@gmail.com</a></li>
						
					</ul>
					<h3 class="section-title">Rejoignez nous</h3>

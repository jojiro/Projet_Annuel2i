        ...
        <div class="container">
            <form method="POST" action="modifUser.php" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <button type="button" class="btn btn-warning btn-block">Supprimer l'image</button>
                    </div>
                </div>

                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label modif-user-label">Changer l'image</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <button type="button" class="btn btn-warning btn-block">Changer le mot de passe</button>
                    </div>
                </div>
                <div class="form-group">

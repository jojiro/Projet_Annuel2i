...
?>
		...
		<section id="signup-block">
			...
			<form method="POST" action="saveUser.php">
					...
					<li><label>
							<input  type="checkbox" name="legacy" required="required">En cochant cette case, je déclare avoir lu, compris et accepté les <a id="cgu-link" href="">Conditions générales d'utilisation</a> de ce site web.
						  </label>
